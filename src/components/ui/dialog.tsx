  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showClose ? (
          <DialogPrimitive.Close className="absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus-visible:ring focus-visible:ring-ring/50 focus-visible:outline-none disabled:pointer-events-none">
