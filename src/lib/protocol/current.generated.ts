...
export interface RunsChangedParams {
  revision: number
  payload: RunsChangedPayload
}

export interface RunsChangedPayload {
  kind: string
  run?: RunSummaryView
  runId?: string
}
...
export interface RunsSubscribeParams {}
...
export interface RunsSubscribeResult {
  payload: RunsSubscribePayload
}

export interface RunsUnsubscribeParams {}

export interface RunsUnsubscribePayload {
  unsubscribed: boolean
}

export interface RunsUnsubscribeResult {
  payload: RunsUnsubscribePayload
}
